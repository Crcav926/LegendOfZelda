...
public class DarkNut : IEnemy, ICollideable
{
    ...
    public DarkNut(Vector2 Position, bool hasKey)
    {
        damageAnimation = new DamageAnimation();
        this.sprite = EnemySpriteFactory.Instance.CreateDefaultDarkNutSprite();
    ...
    public void ChangeDirection()
    {
        ...
        {
            case 0: // Up
                velocity = new Vector2(0, -Constants.DarkNutSpeed);
                //projectileOffset = new Vector2(0, -Constants.GoriyaProjectileOffset);
                sprite = EnemySpriteFactory.Instance.CreateUpDarkNutSprite();  // Switch to up-facing frames
                break;
            case 1: // Down
                velocity = new Vector2(0, Constants.DarkNutSpeed);
                //projectileOffset = new Vector2(0, Constants.GoriyaProjectileOffset);
                sprite = EnemySpriteFactory.Instance.CreateDownDarkNutSprite();
                break;
            case 2: // Left
                velocity = new Vector2(-Constants.DarkNutSpeed, 0);
                //projectileOffset = new Vector2(-Constants.GoriyaProjectileOffset, 0);
                sprite = EnemySpriteFactory.Instance.CreateLeftDarkNutSprite();   // Switch to left-facing frames
                break;
            case 3: // Right
                velocity = new Vector2(Constants.DarkNutSpeed, 0);
                //projectileOffset = new Vector2(Constants.GoriyaProjectileOffset, 0);
                sprite = EnemySpriteFactory.Instance.CreateRightDarkNutSprite();  // Switch to right-facing frames
                break;
        }
    }
