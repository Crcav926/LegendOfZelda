...

{
    ...
    public Zol(SpriteBatch spriteBatch, Vector2 position, Texture2D textures, List<Rectangle> sourceRectangle) : base(spriteBatch, position, textures, sourceRectangle)
    {
